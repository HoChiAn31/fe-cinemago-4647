			...
			>
				<thead>
					<tr className='border-b border-gray1'>
						...
						{/* <th className='border-r border-gray1 p-3'>{t('id')}</th> */}
						<th className='border-r border-gray1 p-3'>{t('name')}</th>
						<th className='border-r border-gray1 p-3'>{t('director')}</th>
						<th className='border-r border-gray1 p-3'>{t('releaseDate')}</th>
				...
				<tbody>
					{movies.map((movie, index) => (
						<tr key={movie.id} className='border-b border-gray1'>
							...
							<td className='border-r border-gray1 p-3 text-center'>{movie.director}</td>
							<td className='border-r border-gray1 p-3 text-center'>{movie.releaseDate}</td>
							<td className='border-r border-gray1 p-3 text-center'>{movie.language}</td>
