...
interface DeleteShowTimeScheduleModalProps {
	isOpen: boolean;
	onOpenChange: () => void;
...
const DeleteShowTimeScheduleModal: React.FC<DeleteShowTimeScheduleModalProps> = ({
	isOpen,
	onOpenChange,
	showTimeToDelete,
	onDeleteShowTime,
...
export default DeleteShowTimeScheduleModal;
